...
macro(archdetect)
  ...
  try_run(run_result_unused compile_result_unused ${CMAKE_CURRENT_BINARY_DIR} "${CMAKE_CURRENT_LIST_DIR}/detect-arch.c" COMPILE_OUTPUT_VARIABLE RAWOUTPUT CMAKE_FLAGS CMAKE_OSX_ARCHITECTURES=${CMAKE_OSX_ARCHITECTURES})
...
elseif(MSVC)
  if("${MSVC_C_ARCHITECTURE_ID}" STREQUAL "x86")
    set(ARCH "x86")
  elseif("${MSVC_C_ARCHITECTURE_ID}" STREQUAL "x64" OR "${MSVC_C_ARCHITECTURE_ID}" STREQUAL "AMD64")
    set(ARCH "x86_64")
...
# Base arch detection
if("${ARCH}" MATCHES "(x86_64|AMD64|i[3-6]86|x86)")
  set(BASEARCH "x86")
